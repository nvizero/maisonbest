<div class="sidebar-nav">
    ...
    <ul id="dashboard-menu" class="nav nav-list collapse in">
        ...
        <li  @if($active=="室內設計")   class="active" @endif ><a href="/interiors">室內設計</a></li>
        <li  @if($active=="電子書")   class="active" @endif ><a href="/books">電子書</a></li>
        <li  @if($active=="users") class="active" @endif ><a href="/users">使用者</a></li>
        <li  @if($active=="igs") class="active" @endif ><a href="/igs">IG</a></li>
