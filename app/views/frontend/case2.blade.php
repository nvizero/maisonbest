    ...
    <section id="map">
        ...
        <div class="googlemap">
            ...
            <iframe width="400" height="300" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"
                    src=http://maps.google.com.tw/maps?f=q&hl=zh-TW&geocode=&q={{$case->latitude}},{{$case->longitude}}&z=13&output=embed></iframe>
            <img src="/images/case/map.jpg">
        </div>
        ...
        <div class="select">
            ...
            <div class="slick3">
                <div class="area"><a href="/case"><p>全部區域</p>
                        <p>ALL</p></a></div>
...
<script type="application/ld+json">
{
  ...
  "url" : "{{Request::url()}}",
  "image" : "@if(  !empty($r_img->image) AND File::exists( public_path().$r_img->image)  )
        http://www.maisonbest.com.tw/public{{$r_img->image}}@endif",
