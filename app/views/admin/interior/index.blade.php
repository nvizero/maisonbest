...
<div class="btn-toolbar">
     <a href="/interior/create" class="btn btn-primary" >新增</a>
  <div class="btn-group">
  </div>
</div>
<div class="well">
    <table class="table table-striped">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
              <a href="/interior/{{$row->id}}"><i class="icon-pencil"></i></a>
...
$("document").ready(function(){
  ...
  $('#myModal').on('shown.bs.modal', function () {
      ...
      // $('.modal-footer').hide()
      $('.user_id').attr('href',"/delinterior/"+$('.user_id').attr('id') );
