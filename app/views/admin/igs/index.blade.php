    ...
    <div class="container-fluid">
        <div class="row-fluid">
            ...
            <div class="btn-toolbar">
                <a href="/ig/create" class="btn btn-primary">新增</a>
                ...
                <table class="table table-striped">
                    ...
                    @foreach($result as $row)
                        ...
                        <tr>
                            ...
                            <td>
                                @if($row->image)
                                    <img src="/public/{{$row->image}}" alt="" style="width: 180px;height: 120px;">
                                @endif
                            </td>
                            <td>{{$row->pr}}</td>

                            <td>
                                <a href="/igs/{{$row->id}}"><i class="icon-pencil"></i></a>
                                <a href="#myModal" id="{{$row->id}}" class="del_user" role="button" data-toggle="modal"><i
