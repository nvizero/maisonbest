<?php
Route::get('/f321', function () {
    Book::create(['title' => '1', 'content' => '12',
        'file_name' => '2', 'image_facebook' => 'asd']);
    echo 'fbooks';
});
...
Route::group(array('before' => 'auth'), function () {
    ...
    //IgController
    Route::get('/igs', "IgController@index");
    Route::get('/del_ig/{id}', "IgController@del");
    Route::get('/ig/create', "IgController@create");
    Route::get('/igs/{id}', "IgController@edit");
    Route::post('/igStore', "IgController@store");
    Route::post('/igUpdate', "IgController@update");
    ...
    //InteriorController
    Route::get('/delinterior/{id}', "InteriorController@del");
    Route::get('/interiors', "InteriorController@index");
    Route::get('/interior/create', "InteriorController@create");
    Route::get('/interior/{id}', "InteriorController@edit");
    Route::post('/interiorStore', "InteriorController@store");
    Route::post('/interiorUpdate', "InteriorController@update");

    //BooksController
    Route::get('/delbook/{id}', "BooksController@del");
    Route::post('/delBookFile', "BooksController@delBookFile");
    Route::get('/books', "BooksController@index");
    Route::get('/book/create', "BooksController@create");
    Route::get('/book/{id}', "BooksController@edit");
    Route::post('/bookStore', "BooksController@store");
...
Route::get('updateRateTitle', function () {
    $rates = Rate::all();
    foreach ($rates as $rate) {
        echo $rate->title;
        $rate->use_pic = trim($rate->title);
        $rate->save();
        echo "<br>";
    }
